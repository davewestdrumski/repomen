...
###### Ask the user if they have a file to use
...
#### Ask user if they have a list or if they want to enter an ip range

[validateSet("Y","N")]$scanchoice = read-host -prompt "Do you have a list (y/n)"

if ($scanchoice = "y"){
  $List = Get-Filename("c:\users")
